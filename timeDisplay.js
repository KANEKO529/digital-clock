...
function updateSubject() {
    ...
    const schedule = [
        ...
        ['Monday', 'はじまりの会', 'コミュ活', 'コミュ活', ['科目学習サポート', '英検準2級対策'], '科目学習サポート', ['プログラミング', '英検準2級対策'], '選択学習', 'おわりの会'],
        ['Tuesday', 'はじまりの会', ['PBL(週1)', 'PBL(週5)'], ['PBL(週1)', 'PBL(週5)'], '科目学習サポート', ['科目学習サポート', 'リベラルアーツ応用'], ['科目学習サポート', 'リベラルアーツ応用'], '選択学習', 'おわりの会'],
        ['Wednesday', 'はじまりの会', ['PBL(基礎)', 'PBL(応用)'], ['PBL(基礎)', 'PBL(応用)'], ['科目学習サポート', '初級英語'], ['科目学習サポート', 'プロN'], ['プログラミング', 'プロN'], '選択学習', 'おわりの会'],
        ['Thursday', 'はじまりの会', 'PBL', 'PBL', '科目学習サポート', ['科目学習サポート', 'クリエイター能力認定試験'], ['プログラミング', 'クリエイター能力認定試験'], '選択学習', 'おわりの会'],
        ['Friday', 'はじまりの会', ['PBL(基礎)', 'PBL(応用)'], ['PBL(基礎)', 'PBL(応用)'], ['科目学習サポート', '英語中級'], ['科目学習サポート', 'プロN'], ['プログラミング', 'プロN'], '選択学習', 'おわりの会'],
